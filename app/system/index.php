...
use GreenCheap\Kernel\Event\ExceptionListener;
return [
    "name" => "system",

    "main" => "GreenCheap\\System\\SystemModule",

    "include" => "modules/*/index.php",

    "require" => ["application", "feed", "markdown", "installer", "system/captcha", "system/view", "system/widget", "system/cache", "system/categories", "system/comment", "system/content", "system/dashboard", "system/editor", "system/finder", "system/info", "system/intl", "system/mail", "system/notifications", "system/settings", "system/site", "system/theme", "system/user"],

    "routes" => [
        "/" => [
            "name" => "@system",
            "controller" => "GreenCheap\\System\\Controller\\AdminController",
        ],
        "/system/migration" => [
            "name" => "@system/migration",
            "controller" => "GreenCheap\\System\\Controller\\MigrationController",
        ],
    ],
    ...
    "events" => [
        "boot" => function ($event, $app) {
            if (!$app["debug"]) {
                $app->subscribe(new ExceptionListener("GreenCheap\System\Controller\ExceptionController::showAction"));
            }
