    ...
    <div>
        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls uk-form-controls-text">
                <div>
                    <label
                        ><input id="form-user-recaptcha-enable" v-model="$root.options['system-captcha'].recaptcha_enable" class="uk-checkbox" type="checkbox" /><span class="uk-margin-small-left">{{ "Enable for user registration and comments" | trans }}</span></label
                    >
                </div>
        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls uk-form-controls-text">
                <div class="uk-margin-small">
                    <label
                        ><input v-model="options.beta" class="uk-checkbox" type="checkbox" value="1" /><span class="uk-margin-small-left">{{ "Enable beta version mode" | trans }}</span></label
                    >
                </div>
                <div class="uk-margin-small">
                    <label
                        ><input v-model="$root.config.application.debug" class="uk-checkbox" type="checkbox" value="1" /><span class="uk-margin-small-left">{{ "Enable debug mode" | trans }}</span></label
                    >
                </div>
                <div class="uk-margin-small">
                    <label
                        ><input v-model="$root.config.debug.enabled" class="uk-checkbox" type="checkbox" value="1" :disabled="!sqlite" /><span class="uk-margin-small-left">{{ "Enable debug toolbar" | trans }}</span></label
                    >
                </div>
