<template>
    <div>
        ...
        <div v-if="status !== 'loading'" class="uk-card uk-card-default uk-card-body uk-card-small">
            <div class="uk-grid-collapse uk-child-width-1-2" uk-grid>
                <div class="uk-flex uk-flex-left">
                    <h2 class="uk-h4 uk-text-bold uk-text-center uk-margin-remove" v-if="time">{{ time | date }}</h2>
                </div>
                <div class="uk-flex uk-flex-right">
                    <h2 class="uk-h4 uk-text-bold uk-text-center uk-margin-remove" v-if="time">{{ time | date(format) }}</h2>
                </div>
            </div>
        </div>
