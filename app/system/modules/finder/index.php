...
return [
    ...
    'routes' => [
        ...
        '/system/finder' => [
            'name' => '@system/finder',
            'controller' => 'GreenCheap\\Finder\\Controller\\FinderController'
        ],
        '/storage' => [
            'name' => '@storage',
            'controller' => 'GreenCheap\\Finder\\Controller\\StorageController'
        ]
    ...
    'events' => [
        ...
        'view.scripts' => function ($event, $scripts) {
            ...
            $scripts->register('multi-finder', 'system/finder:app/bundle/multi-finder.js', ['vue', 'uikit']);
        },
