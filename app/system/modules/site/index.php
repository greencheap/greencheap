...
use GreenCheap\Site\Event\MaintenanceListener;
use GreenCheap\Site\Event\NodesListener;
use GreenCheap\Site\Event\PageListener;
use GreenCheap\Site\MenuHelper;
...
return [
    ...
    "routes" => [
        "/" => [
            "name" => "@site",
            "controller" => "GreenCheap\\Site\\Controller\\NodeController",
        ],
        "/api/site/menu" => [
            "name" => "@site/api/menu",
            "controller" => "GreenCheap\\Site\\Controller\\MenuApiController",
        ],
        "/api/site/node" => [
            "name" => "@site/api/node",
            "controller" => "GreenCheap\\Site\\Controller\\NodeApiController",
        ],
        "/api/site/page" => [
            "name" => "@site/api/page",
            "controller" => "GreenCheap\\Site\\Controller\\PageApiController",
        ],
    ],

    "widgets" => ["widgets/menu.php", "widgets/text.php"],
