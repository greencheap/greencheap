            ...
            <div class="uk-margin">
                ...
                <div class="uk-form-controls uk-form-controls-text">
                    <p class="uk-margin-small">
                        <label
                            ><input v-model="widget.data.mode" class="uk-radio" type="radio" value="all" /><span class="uk-margin-small-left">{{ "Show all" | trans }}</span></label
                        >
                    </p>

                    <p class="uk-margin-small">
                        <label
                            ><input v-model="widget.data.mode" class="uk-radio" type="radio" value="active" /><span class="uk-margin-small-left">{{ "Show only for active item" | trans }}</span></label
                        >
                    </p>
                </div>
            </div>
    ...
    created() {
        ...
        this.$http.get("api/site/menu").then(function (res) {
            this.$set(
                this,
                "menus",
                res.data.filter((menu) => menu.id !== "trash")
            );
        });
    },
};
