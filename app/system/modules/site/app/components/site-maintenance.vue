        ...
        <div class="uk-form-horizontal">
            <div class="uk-margin">
                ...
                <div class="uk-form-controls uk-form-controls-text">
                    <label
                        ><input v-model="config.maintenance.enabled" class="uk-checkbox" type="checkbox" value="1" /><span class="uk-margin-small-left">{{ "Put the site offline and show the offline message." | trans }}</span></label
                    >
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-form-controls">
                    <textarea id="form-offlinemessage" v-model="config.maintenance.msg" class="uk-form-width-large uk-textarea" :placeholder="'We\'ll be back soon.' | trans" rows="5" />
                </div>
            </div>
