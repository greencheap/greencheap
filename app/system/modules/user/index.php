...
return [
    ...
    'routes' => [
        ...
        '/user' => [
            'name' => '@user',
            'controller' => [
                'GreenCheap\\User\\Controller\\AuthController',
                'GreenCheap\\User\\Controller\\UserController'
            ]
        ],
        '/user/profile' => [
            'name' => '@user/profile',
            'controller' => [
                'GreenCheap\\User\\Controller\\ProfileController',
            ]
        ],
        '/user/registration' => [
            'name' => '@user/registration',
            'controller' => [
                'GreenCheap\\User\\Controller\\RegistrationController',
            ]
        ],
        '/user/resetpassword' => [
            'name' => '@user/resetpassword',
            'controller' => [
                'GreenCheap\\User\\Controller\\ResetPasswordController',
            ]
        ],
        '/api/user' => [
            'name' => '@user/api',
            'controller' => [
                'GreenCheap\\User\\Controller\\UserApiController'
            ]
        ],
        '/api/user/role' => [
            'name' => '@user/api/role',
            'controller' => [
                'GreenCheap\\User\\Controller\\RoleApiController'
            ]
        ]
