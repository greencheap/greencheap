                    ...
                    <div class="uk-card uk-card-default uk-card-body uk-panel" style="padding: 20px">
                        ...
                        <div class="uk-margin">
                            <div class="uk-inline uk-width-1-1">
                                ...
                                <input v-model="credentials.username" class="uk-input uk-form-large" type="text" name="credentials[username]" :placeholder="'Username' | trans" autofocus />
                            </div>
                        </div>
                        ...
                        <div class="uk-margin">
                            <div class="uk-inline uk-width-1-1">
                                ...
                                <input ref="password" v-model="credentials.password" class="uk-input uk-form-large" type="password" name="credentials[password]" :placeholder="'Password' | trans" />
                            </div>
                        </div>
                        ...
                        <p class="uk-margin-remove-bottom">
                            <label class=""
                                ><input v-model="remember" class="uk-checkbox" type="checkbox" /><span class="uk-margin-small-left">{{ "Remember Me" | trans }}</span></label
                            >
                        </p>
                    </div>
                </form>
