                    ...
                    <div>
                        <div class="uk-child-width-1-2 uk-grid-small uk-text-small" uk-grid>
                            <div class="uk-text-nowrap uk-text-truncate">
                                <label
                                    ><input class="uk-checkbox" type="checkbox" v-model="video.data.autoplay" /><span class="uk-margin-small-left">{{ "Autoplay" | trans }}</span></label
                                ><br />
                                <label v-show="!isVimeo"
                                    ><input class="uk-checkbox" type="checkbox" v-model="video.data.controls" /><span class="uk-margin-small-left">{{ "Controls" | trans }}</span></label
                                >
                            </div>
                            <div class="uk-text-nowrap uk-text-truncate">
                                <label
                                    ><input class="uk-checkbox" type="checkbox" v-model="video.data.loop" /><span class="uk-margin-small-left">{{ "Loop" | trans }}</span></label
                                ><br />
                                <label v-show="!isVimeo && !isYoutube"
                                    ><input class="uk-checkbox" type="checkbox" v-model="video.data.muted" /><span class="uk-margin-small-left">{{ "Muted" | trans }}</span></label
                                >
                            </div>
                        </div>
                    </div>
