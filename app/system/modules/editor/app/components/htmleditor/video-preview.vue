<template>
    ...
    <div class="uk-form-width-large uk-inline-clip uk-transition-toggle uk-visible-toggle" v-else>
        ...
        <div class="uk-card-badge pk-panel-badge uk-invisible-hover">
            <ul class="uk-subnav pk-subnav-icon">
                <li><a class="pk-icon-delete pk-icon-hover" :title="'Delete' | trans" uk-tooltip="delay: 500" @click.prevent="remove" v-confirm="'Reset video?'"></a></li>
            </ul>
        </div>
