...
export default {
    ...
    created() {
        ...
        this.$asset({
            css: [baseURL + "/app/assets/codemirror/show-hint.css", baseURL + "/app/assets/codemirror/codemirror.css"],
            js: [baseURL + "/app/assets/codemirror/codemirror.min.js", baseURL + "/app/assets/marked/marked.min.js"],
        }).then(function () {
            var editor = (this.$parent.editor = UIkit.htmleditor(
                this.$parent.$refs.editor,
                _.extend(
                    {
