    ...
    <body>
        ...
        <div class="uk-height-viewport uk-flex uk-flex-center uk-flex-middle uk-text-center">
            <div class="tm-container">
                ...
                <img class="uk-margin-large-bottom" src="<?= $view->url()->getStatic('app/system/assets/images/greencheap-logo-large-black.svg') ?>" alt="GreenCheap">

                <form class="uk-panel uk-panel-box" action="<?= $view->url('@system/migration/migrate') ?>">
                    <h1><?= __('Update GreenCheap') ?></h1>
