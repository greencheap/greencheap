    ...
    methods: {
        ...
        init() {
            ...
            var previewContainer = this.iframe ? this.preview.container : $this.preview.parentNode,
                ...
                codeScroll = on(
                    find(".CodeMirror-scroll", this.code),
                    "scroll",
                    debounce(function () {
            ...
            on(this.htmleditor, "click", ".uk-htmleditor-button-code, .uk-htmleditor-button-preview", function (e) {
                ...
                if ($this.htmleditor.getAttribute("data-mode") == "tab") {
                    ...
                    addClass(
                        findAll(".uk-htmleditor-button-code, .uk-htmleditor-button-preview", $this.htmleditor).filter((el) => {
                            return el === e.target.parentNode;
                        }),
                        "uk-active"
                    );
        ...
        fit: function () {
            ...
            if (mode == "tab") {
                ...
                removeClass(findAll(".uk-htmleditor-button-code, .uk-htmleditor-button-preview", this.htmleditor), "uk-active");
                addClass(
                    findAll(".uk-htmleditor-button-code, .uk-htmleditor-button-preview", this.htmleditor).filter((el) => hasClass(el, this.activetab == "code" ? "uk-htmleditor-button-code" : "uk-htmleditor-button-preview")),
                    "uk-active"
                );
            }
        ...
        render: function () {
            ...
            if (!this.enablescripts) {
                this.currentvalue = this.currentvalue.replace(/<(script|style)\b[^<]*(?:(?!<\/(script|style)>)<[^<]*)*<\/(script|style)>/gim, "");
            }
            ...
            on(editor.htmleditor, "click", 'a[data-htmleditor-button="fullscreen"]', function (e) {
                ...
                if (hasClass(editor.htmleditor, "uk-htmleditor-fullscreen")) {
                    var fixedParent = false,
                        $parents = parents(editor.htmleditor, "*");
        ...
        initMarked: function () {
            ...
            on(editor.$el, "enableMarkdown", function () {
                editor.enableMarkdown();
            });
            on(editor.$el, "disableMarkdown", function () {
