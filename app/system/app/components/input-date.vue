...
export default {
    ...
    mounted() {
        this.$nextTick(() => {
            flatpickr(
                $("input", this.$refs.datepicker),
                _.extend(this.options.datepicker, {
                    altInput: true,
            ...
            flatpickr(
                $("input", this.$refs.timepicker),
                _.extend(this.options.timepicker, {
...
Vue.component("input-date", (resolve, reject) => {
    Vue.asset({
        css: ["app/assets/flatpickr/dist/flatpickr.min.css"],
        js: ["app/assets/flatpickr/dist/flatpickr.min.js"],
    }).then(() => {
