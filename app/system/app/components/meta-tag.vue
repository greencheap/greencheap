<template>
    <div>
        <div class="uk-margin">
            <label for="form-meta-title" class="uk-form-label">{{ 'Meta Title' | trans }} <span v-show="countTitle > 0">{{countTitle}}</span></label>
        ...
        <div class="uk-margin">
            <label for="form-meta-description" class="uk-form-label">{{ 'Meta Description' | trans }} <span v-show="countDesc > 0">{{countDesc}}</span></label>
            <div class="uk-form-controls">
...
export default {
    ...
    created(){
        if( !this.source['vmeta'] ){
            this.$set(this , 'resource' , _.merge({
                vmeta:{
                    'og:title':'',
                    'og:description':'',
                    'og:keyword':''
