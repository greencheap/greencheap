...
var ThemeTabs = function (name, ele, option) {
    ...
    var element,
        elements = this.$data.$themeElements;
    ...
    var render = {
                    ...
                    [
                        h("ul", { class: "uk-nav uk-dropdown-nav" }, [
                            $this.orderBy(get(this, "items"), "priority").map((item, name) => {
                                ...
                                return get(item, "vif") && h("li", null, [render[item.type].call(item)]);
                            }),
                        ]),
                    ]
                ),
        ...
        button() {
            let spinner = get(this, "spinner"),
                ...
                elements = (h) => {
                    let elements = [];
                    spinner && elements.push([render.spinner(h)]);
                    icon &&
                        internal &&
                        elements.push([
                            h("span", {
                    ...
                    if (get(this, "caption")) {
                        if ((icon || spinner) && !internal) {
                            elements.push([h("span", { class: "uk-text-middle" }, getText(get(this, "caption")))]);
                        } else if (icon && internal) {
                            elements.push([h("span", { class: "uk-text-middle uk-margin-small-right" }, getText(get(this, "caption")))]);
                        } else if (!icon) {
                            elements.push([getText(get(this, "caption"))]);
                        }
                    }
                    return elements;
                };
        ...
        iconnav() {
            ...
            return h(
                "ul",
                { class: "uk-iconnav" },
                get(this, "items").map((item) => get(item, "vif") && h("li", {}, [create(h, item)]))
            );
        },
        caption() {
            if (get(this, "class")) {
        ...
        spinner() {
            return h(
                ...
                [h("span", { class: "tm-bounce1" }), h("span", { class: "tm-bounce2" }), h("span", { class: "tm-bounce3" })]
            );
        },
    };
    ...
    var render = {
            ...
            return h(
                ...
                [
                    h("div", { class: ["tm-topmenu-item"] }, [
                        h(
                            "ul",
                            { class: "tm-action-buttons uk-subnav uk-flex uk-flex-middle uk-visible@m" },
                            this.orderBy(items, "priority").map((element) => !isElementEmpty(element) && get(element, "vif") && h("li", { class: { "uk-disabled": get(element, "disabled") } }, [renderElement(h, element, this)]))
                        ),
                    ]),
                ]
            );
        ...
        sidemenu: () => {
            var sb = this.$parent.sb,
                breakpoint = this.$parent.$breakpoint;
            return h("ul", { class: ["tm-action-buttons", { "uk-nav uk-nav-default": !sb }, { "uk-iconnav": sb }, { "uk-flex-nowrap": sb && isEmpty }] }, [
                ...
                !isEmpty && this.orderBy(items, "priority").map((element) => !isElementEmpty(element) && get(element, "vif") && h("li", { class: { "uk-disabled": get(element, "disabled") } }, [renderElement(h, element, this)])),
                sb && h("li", { class: "uk-width-expand" }, [isEmpty && h("div", { class: ["uk-height-1-1 uk-flex uk-flex-middle uk-light", { "uk-hidden": !breakpoint }] }, [h("span", this.$trans("Extensions"))])]),
            ]);
        },
        breadcrumbs: () => {
            return h(
                "ul",
                { class: "tm-breadcrumbs uk-nav uk-visible@m" },
                this.orderBy(items, "priority").map(
                    (element) =>
        ...
        navbar: () => {
            return h(
                "div",
                { class: [dir == "navbar-right" ? "uk-margin-right" : "uk-navbar-item", "uk-visible@m"] },
                this.orderBy(items, "priority").map((element) => !isElementEmpty(element) && get(element, "vif") && renderElement(h, element, this))
            );
        },
    };
...
var ThemeTopMenu = {
    render(h) {
        ...
        return (
            ...
            h(
                "div",
                { class: "tm-topmenu uk-visible@m" },
                scopes.map((scope) => renderScope.call(this, h, "topmenu", scope))
            )
        );
    },
    created() {
...
ThemeHelper.prototype.get = function (item, prop, e) {
    ...
    if (this.testProp(prop, "disabled")) return isUndefined(value) ? false : this.test(value);
...
ThemeHelper.prototype.isScopeEmpty = function (menu) {
    return !(
        objLength(menu) &&
        Object.values(menu)
            .map((ele) => !this.isElementEmpty(ele))
