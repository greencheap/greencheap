...
namespace GreenCheap\Filesystem\Tests;

use GreenCheap\Filesystem\Filesystem;
use GreenCheap\Filesystem\Locator;
...
class LocatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataGetPaths()
    {
        ...
        return [["Fixtures", $fixtures, true], ["/Fixtures", $fixtures, true], ["Fixtures/file1.txt", $fixtures . "/file1.txt", true], ["/Fixtures/file1.txt", $fixtures . "/file1.txt", true], ["Fixtures/file3.txt", false, false], ["/Fixtures/file3.txt", false, false]];
    }
