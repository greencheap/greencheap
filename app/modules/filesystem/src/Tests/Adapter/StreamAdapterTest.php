...
namespace GreenCheap\Filesystem\Tests\Adapter;

use GreenCheap\Filesystem\Adapter\StreamAdapter;
use GreenCheap\Filesystem\Filesystem;
use GreenCheap\Filesystem\StreamWrapper;

class StreamAdapterTest extends \PHPUnit_Framework_TestCase
{
    use \GreenCheap\Tests\FileUtil;
