...
use GreenCheap\Routing\Event\AliasListener;
use GreenCheap\Routing\Event\ConfigureRouteListener;
use GreenCheap\Routing\Event\RouterListener;
use GreenCheap\Routing\Loader\RoutesLoader;
use GreenCheap\Routing\Middleware;
use GreenCheap\Routing\Request\ParamFetcher;
use GreenCheap\Routing\Request\ParamFetcherListener;
use GreenCheap\Routing\Router;
use GreenCheap\Routing\Routes;
...
return [
    ...
    "events" => [
        "boot" => function ($event, $app) {
            $app->subscribe(new ConfigureRouteListener(), new ParamFetcherListener(new ParamFetcher(new FilterManager())), new RouterListener($app["router"]), new AliasListener($app["routes"]));
    ...
    "require" => ["kernel", "filter"],

    "autoload" => [
        "GreenCheap\\Routing\\" => "src",
    ],
];
