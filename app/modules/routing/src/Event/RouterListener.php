...
use GreenCheap\Kernel\Exception\MethodNotAllowedException as MethodNotAllowedHttpException;
use GreenCheap\Kernel\Exception\NotFoundException as NotFoundHttpException;
