        ...
        <installer-steps :steps="steps" :current="step">
            ...
            <template v-slot:database="{ step, passes }">
                <div :step="step" class="uk-panel">
                    ...
                    <div class="uk-alert uk-alert-danger uk-margin uk-text-center" v-show="message">
                        <p>{{ message }}</p>
                    </div>
                        ...
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <select id="form-dbdriver" class="uk-width-1-1 uk-select" name="dbdriver" v-model="config.database.default">
                                    <option v-if="sqlite" value="sqlite">SQLite</option>
                            ...
                            <div class="uk-margin">
                                ...
                                <v-input
                                    ...
                                    :view="{
                                        ...
                                        containerClass: 'uk-form-controls',
                                        iconTag: 'a',
                                        iconDir: 'right',
                                        iconClick: () => {
                                    ...
                                    v-model="config.database.connections.pgsql.password"
                                />
                            </div>
                            <div class="uk-margin">
...
let Installer = {
    ...
    created() {
        ...
        _.forEach(this.config.database.connections, (connection) => {
            _.extend(connection, { prefix: "gc_" });
        });
    },
